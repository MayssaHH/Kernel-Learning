...
from data.generators.two_outer_circles_middle import (
...
def run_experiement(
    ...
    dataset_name: str = "two_outer_circles_middle",
    experiment_slug: str = "test6_useless_features",
    experiment_name: str = "test6_useless_feature_selection",
    signal_generator: Callable = generate_two_outer_circles_with_middle,
    ...
    two_moons_noise_std: float = 0.35,
    ...
    """
    Test 6: same experiment protocol as test3, but default signal dataset is:
    class 1 = two outer circles, class 0 = middle region.
...
if __name__ == "__main__":
    run_experiement(
        dataset_name="two_outer_circles_middle",
        experiment_slug="test6_useless_features",
        experiment_name="test6_useless_feature_selection",
        signal_generator=generate_two_outer_circles_with_middle,
        signal_generator_kwargs={
        ...
        num_signal_features=20,
        allow_signal_expansion=True,
        signal_expansion_mode="mixed",
        signal_expansion_noise_std=0.01,
        noise_feature_counts=[0, 2, 5, 10, 20, 50, 100],
        samples_per_class=300,
        two_moons_noise_std=0.35,

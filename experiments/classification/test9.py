...
def run_experiement(
    ...
    """
    Test 9: professor-style protocol with larger signal blocks and feature shuffling.
    ...
    results_dir = Path(results_root) / f"{run_uuid}_test9_professor_data_shuffled_types"
    if save_results:
    ...
    plt.title("Test 9 (Professor Data, Shuffled Features): Accuracy vs Pure Noise Predictors")
    plt.ylim(0.0, 1.05)
    plt.grid(alpha=0.3)
    plt.legend()
    ...
    plt.title("Test 9: Signal/Noise Alpha Mass vs Pure Noise Predictors")
    plt.ylim(0.0, 1.05)
    plt.grid(alpha=0.3)
    plt.legend()
    ...
    plt.xlabel("Number of Pure Noise Predictors (pn)")
    plt.ylabel("Mean Alpha Mass")
    plt.title("Test 9: Alpha Mass by Feature Type vs Pure Noise Predictors")
    plt.ylim(0.0, 1.05)
    plt.grid(alpha=0.3)
    plt.legend()
    ...
    manifest = {
        ...
        "config": {
            "experiment_name": "test9_professor_data_shuffled_types",
